//private scope is inaccesible to the user and can't be directly accessed by them but public scope can be accessed by the user. as such in the code written below,
//if you try to access private function, the compiler will show an output error.
#include<iostream>
using namespace std;
class Student{
    string name;
